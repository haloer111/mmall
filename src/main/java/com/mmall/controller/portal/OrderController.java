...
public class OrderController {
    ...
    @ResponseBody
    public ServerResponse create(HttpSession session, Long orderNo, Integer shippingId, HttpServletRequest
            httpServletRequest) {
        ...
        return ServerResponse.createBySuccess(iOrderService.createOrder(user.getId(), shippingId));
    }
    ...
    public ServerResponse pay(HttpSession session, Long orderNo, HttpServletRequest request) {
        ...
        return ServerResponse.createBySuccess(iOrderService.pay(orderNo, user.getId(), path));
    }
    ...
    @ResponseBody
    public ServerResponse<Boolean> queryOrderPayStatus(HttpSession session, Long orderNo, HttpServletRequest
            httpServletRequest) {
        String loginToken = CookieUtil.readLoginToken(httpServletRequest);
        if (StringUtils.isEmpty(loginToken)) {
            return ServerResponse.createByErrorMessage("用户未登录，无法获取当前用户信息");
    ...
    public ServerResponse cancel(HttpSession session, Long orderNo, HttpServletRequest httpServletRequest) {
        ...
        User user = JsonUtil.string2Obj(userJsonStr, User.class);
        if (user == null) {
            return ServerResponse.createByError(ResponseCode.NEED_LOGIN.getCode(), ResponseCode.NEED_LOGIN.getDes());
        }
